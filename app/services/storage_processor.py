...
from app.services.db_manager import (update_user_profile, update_miner_profile, load_profiles_to_memory,
                      get_pending_storage_requests, update_storage_request_status,
                      get_storage_miners)
from app.services.ipfs_api import ping_ipfs_node, get_file_size
...
async def score_miners(miners: List[Dict]) -> List[Dict]:
    ...
    for miner in miners:
        ...
        scored_miners.append({'node_id': node_id, 'ipfs_peer_id': miner['ipfs_peer_id'],

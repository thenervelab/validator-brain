"""Inspect RabbitMQ queue to see message count and contents."""
...
async def inspect_queue(queue_name: str = 'user_profile'):
    ...
    try:
        ...
        if queue.declaration_result.message_count > 0:
            print("\nPeeking at first few messages (not consuming):")
            print("-" * 60)

...
async def reconstruct_miner_profiles(miner_data: List[Dict], health_data: List[Dict]) -> List[Dict]:
    """
    ...
    for miner in miner_data:
        ...
        profile = MinerStorageProfile(
            ...
            storage_capacity_bytes=miner.get("storage_capacity_bytes", 1000000000),
            total_files_pinned=miner.get("total_files_pinned", 0),
            total_files_size_bytes=miner.get("total_files_size_bytes", 0)
        )
